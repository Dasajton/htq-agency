                ...
                <div className="container mt-10 mx-auto px-2">
                    <div className="flex flex-col gap-6">
                        ...
                        <p className="text-lg">
                            ...
                            Prozessoptimierung und Digitalisierung. Mit unserem
                            erfahrenen Team aus Experten begleiten wir Sie auf
                            dem Weg zu nachhaltigem Erfolg und unterstützen Sie
